...
switch(e.keyCode){case n.SPACE:this.toggleProperty("checked"),t=!0}t&&(e.stopPropagtion(),e.preventDefault())},click:function(){this.toggleProperty("checked")},focusIn:function(){s(this,"focus",!0)},focusOut:function(){s(this,"focus",!1)}})}),define("ember-aria-checkbox/templates/components/aria-checkbox",["exports"],function(e){"use strict"
