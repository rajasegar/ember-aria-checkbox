...
Object.defineProperty(e,"__esModule",{value:!0})
var n={RETURN:13,SPACE:32},r=Ember.Component,i=Ember.computed,o=Ember.get,s=Ember.set
e.default=r.extend({layout:t.default,classNameBindings:["focus:focus"],attributeBindings:["role","ariaChecked:aria-checked","tabindex"],role:"checkbox",ariaChecked:i("checked",function(){return o(this,"checked")?"true":"false"}),focus:!1,checked:!1,tabindex:0,keyDown:function(e){var t=!1
switch(e.keyCode){case n.SPACE:this.toggleProperty("checked"),t=!0}t&&(e.stopPropagation(),e.preventDefault())},click:function(){this.toggleProperty("checked")},focusIn:function(){s(this,"focus",!0)},focusOut:function(){s(this,"focus",!1)}})}),define("ember-aria-checkbox/templates/components/aria-checkbox",["exports"],function(e){"use strict"
